...
import 'package:college_app/college/a_notes/subject_management.dart';
...
class _SelectSemesterPageState extends State<SelectSemesterPage> 
  ...
  List<Map<String, dynamic>> _getSemesterData() {
    ...
    for (int i = 0; i < semesterCount; i++) {
      ...
      semesters.add({
        ...
        'subtitle': 'Manage subjects and materials',
        'icon': Icons.school,
  ...
  void _navigateToSubjectsPage(BuildContext context, String semester) {
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => SubjectManagementPage(
