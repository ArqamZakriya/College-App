...
class CollegeStaffManagementPage extends StatefulWidget {
  const CollegeStaffManagementPage({super.key});

  @override
  _CollegeStaffManagementPageState createState() =>
      _CollegeStaffManagementPageState();
}

class _CollegeStaffManagementPageState
    extends State<CollegeStaffManagementPage> {
