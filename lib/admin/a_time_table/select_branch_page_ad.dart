...
import 'package:college_app/admin/a_time_table/aiml_sem.dart';
import 'package:college_app/admin/a_time_table/basic_sceince_sem.dart';
import 'package:college_app/admin/a_time_table/civil_sem.dart';
import 'package:college_app/admin/a_time_table/cse_sem.dart';
import 'package:college_app/admin/a_time_table/ece_sem.dart';
import 'package:college_app/admin/a_time_table/eee_sem.dart';
import 'package:college_app/admin/a_time_table/ise_sem.dart';
import 'package:college_app/admin/a_time_table/mech_sem.dart';
import 'package:college_app/admin/a_time_table/rai_sem.dart';
import 'package:flutter/material.dart';

class SelectBranchPageAd extends StatelessWidget {
  const SelectBranchPageAd({super.key});
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _BranchButton(title: 'AIML', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const AimlSem()),
                          );
                      }),
                      _BranchButton(title: 'CSE', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const CseSem()),
                          );
                      }),
                      _BranchButton(title: 'EEE', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const EeeSem()),
                          );
                      }),
                      _BranchButton(title: 'MECH', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const MechSem()),
                          );
                      }),
                      _BranchButton(title: 'ECE', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const EceSem()),
                          );
                      }),
                      _BranchButton(title: 'RAI', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const RaiSem()),
                          );
                      }),
                      _BranchButton(title: 'CIVIL', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const CivilSem()),
                          );
                      }),
                      _BranchButton(title: 'ISE', onTap: () {Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const IseSem()),
                          );}),
                      _BranchButton(title: 'BASIC SCIENCE', onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const BasicSceinceSem()),
                          );
                      }),
                    ],
                  ),
